 ...
 function Display (props) {
    ...
    return (
      ...
      <div id="drum-machine" className="mx-auto text-center bg-light" style={{width: '400px', height: '400px', minWidth: '400px', borderRadius: '5px'}}>
        <button  onClick={() => props.handleClick(disp[0])} className="btn bg-info m-1" id={disp[0]} key='1'>Q</button>
        <button onClick={() => props.handleClick(disp[1])} className="btn bg-info m-1" id={disp[1]} key='2'>W</button>
        <button onClick={() => props.handleClick(disp[2])} className="btn bg-info m-1" id={disp[2]}  key='3'>E</button>
        <div className="w-100"></div>
        <button onClick={() => props.handleClick(disp[3])} className="btn bg-info m-1" id={disp[3]}  key='4'>A</button>
        <button onClick={() => props.handleClick(disp[4])} className="btn bg-info m-1" id={disp[4]}  key='5'>S</button>
        <button onClick={() => props.handleClick(disp[5])} className="btn bg-info m-1" id={disp[5]}  key='6'>D</button>
        <div className="w-100"></div>
        <button onClick={() => props.handleClick(disp[6])} className="btn bg-info m-1" id={disp[6]}  key='7'>Z</button>
        <button onClick={() => props.handleClick(disp[7])} className="btn bg-info m-1" id={disp[7]}  key='8'>X</button>
        <button onClick={() => props.handleClick(disp[8])} className="btn bg-info m-1" id={disp[8]}  key='9'>C<audio></audio></button>
        <div>
